<template>
  <div>
    ...
    <data-bar
      v-show="showPie"
      :title="pieTitle"
      style="top: 10px; right: 60px; width: 356px; height: 350px"
    >
    ...
    <data-bar
      v-show="showBar"
      :title="barTitle"
      style="top: 380px; right: 60px; width: 356px; height: 460px"
    >
...
let BASE_modeurl =
  "http://localhost:8090//pop_perceive/tra-popod/getOOnes?code=";
let BASE_sumurl =
  "http://localhost:8090//pop_perceive/tra-popod/getOOnesByStreet/?code=";
export default {
  data() {
    return {
      tripOptions: [
  ...
  methods: {
    changeMode(val) {
      ...
      switch (val) {
        case "o":
          BASE_modeurl =
            "http://localhost:8090//tra_monitor/tra-carod/getOOnes?code=";
          BASE_sumurl =
            "http://localhost:8090//tra_monitor/tra-carod/getOOnesByStreet/?code=";
          _this.pieTitle = "到各区货车联系强度占比";
          _this.barTitle = "货车联系强度前十地区";
          break;
        case "d":
          BASE_modeurl =
            "http://localhost:8090//tra_monitor/tra-carod/getDOnes?code=";
          BASE_sumurl =
            "http://localhost:8090//tra_monitor/tra-carod/getDOnesByStreet/?code=";
