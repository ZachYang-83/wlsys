...
let BASE_modeurl =
  "http://localhost:8090//tra_monitor/tra-rel-int/getOOnes/?code=";
let BASE_sumurl =
  "http://localhost:8090//tra_monitor/tra-rel-int/getOOnesByCity/?code=";
export default {
  data() {
    return {
      tripOptions: [
  ...
  methods: {
    changeMode(val) {
      ...
      switch (val) {
        ...
        case "d":
          BASE_modeurl =
            "http://localhost:8090//tra_monitor/tra-rel-int/getDOnes/?code=";
          BASE_sumurl =
            "http://localhost:8090//tra_monitor/tra-rel-int/getDOnesByCity/?code=";
