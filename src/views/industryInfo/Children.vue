<template>
  <Legend
    :title="title"
    :items="items"
    style="bottom: 40px; left: 110px; width: 200px; height: auto"
  >
  </Legend>
</template>
  ...
  methods: {
    ...
    loadWMS() {
      ...
      window.MAP.addSource("children", {
        ...
        scheme: "tms",
        tiles: [
          "http:/localhost:8181/geoserver/gwc/service/tms/1.0.0/gpzi%3Achildren@EPSG%3A900913@pbf/{z}/{x}/{y}.pbf",
        ],
        // maxzoom: 8,
      });
      window.MAP.addLayer({
      ...
      window.MAP.addSource("city_county", {
        ...
        scheme: "tms",
        tiles: [
          "http:/localhost:8181/geoserver/gwc/service/tms/1.0.0/gpzi%3Acity_county@EPSG%3A900913@pbf/{z}/{x}/{y}.pbf",
        ],
        // maxzoom: 8,
      });
      window.MAP.addLayer({
      ...
      window.MAP.addSource("gz_line", {
        ...
        scheme: "tms",
        tiles: [
          "http:/localhost:8181/geoserver/gwc/service/tms/1.0.0/gpzi%3Agz_line@EPSG%3A900913@pbf/{z}/{x}/{y}.pbf",
        ],
        // maxzoom: 8,
      });
      window.MAP.addLayer({
