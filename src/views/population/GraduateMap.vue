  ...
  methods: {
    ...
    add_jiuyeLayers() {
      ...
      window.MAP.addSource("jiuye_symbol", {
        ...
        scheme: "tms",
        tiles: [
          "http:/localhost:8181/geoserver/gwc/service/tms/1.0.0/gpzi%3Astu_picture_sym@EPSG%3A900913@pbf/{z}/{x}/{y}.pbf",
        ],
        tileSize: 512,
      });
      window.MAP.addLayer({
    ...
    add_jiuyeLayers2() {
      ...
      window.MAP.addSource("jiuye_symbol2", {
        ...
        scheme: "tms",
        tiles: [
          "http:/localhost:8181/geoserver/gwc/service/tms/1.0.0/gpzi%3Astu_picture_sym2@EPSG%3A900913@pbf/{z}/{x}/{y}.pbf",
        ],
        tileSize: 512,
      });
      window.MAP.addLayer({
