...
let BASE_modeurl =
  "http://localhost:8090//pop_perceive/gd-disod/getOOnes/?dis=";
let BASE_sumurl =
  "http://localhost:8090//pop_perceive/gd-disod/getOOnesByCity/?dis=";
export default {
  data() {
    return {
      tripOptions: [
  ...
  methods: {
    changeMode(val) {
      ...
      switch (val) {
        ...
        case "d":
           BASE_modeurl =
            "http://localhost:8090//pop_perceive/gd-disod/getDOnes/?dis=";
          BASE_sumurl =
            "http://localhost:8090//pop_perceive/gd-disod/getDOnesByCity/?dis=";
